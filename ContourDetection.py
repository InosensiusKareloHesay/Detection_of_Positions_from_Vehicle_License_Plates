...
# ------------------ Proses Contour Detection -----------------------
                    ...
                    if len(alignContour) == 2:
                        if (alignContour[0][0][1] < alignContour[1][0][1] and alignContour[0][0][0] < alignContour[1][0][0]):
                            ...
                            while tresholdCrop[0][j] != 255 and xDua > maxDua:
                                ...
                                j += 1
                            k = 0
                            alignContourBaru = np.array([[[xSatu - 3, alignContour[0][0][1]]], [[xDua, alignContour[0][0][1]]],
                                                         [[alignContour[1][0][0], alignContour[1][0][1]]],
                                                         [[xSatu + j - 3, alignContour[1][0][1]]]])
                            
                        elif (alignContour[0][0][1] < alignContour[1][0][1] and alignContour[0][0][0] > alignContour[1][0][0]):
